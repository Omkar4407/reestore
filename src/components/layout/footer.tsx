...
export default async function Footer() {
  ...
  return (
    <>
      {/* BLOG SECTION */}
      <section className="bg-[#d3f7f0] pt-8 md:pt-16">
              ...
              >
                ...
                <div className="p-4 flex flex-col flex-1">
                  ...
                  {blog.excerpt && (
                    ...
                    <p className="mt-4 text-[13px] leading-[1.85] font-medium text-black/60">
                      {blog.excerpt}
                    </p>
                  )}
      ...
      {/* FOOTER */}
      <footer className="bg-[#0d5c4d] text-white pt-0 pb-8 md:pb-10 overflow-hidden">
        ...
        <div className="max-w-[1600px] mx-auto px-4 md:px-6 pt-8 md:pt-0">
          ...
          {/* TOP */}
          <div className="flex items-center justify-between mb-5 md:mb-8 border-b border-white/10 pb-5 md:pb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            ...
            <div>
              ...
              <h3 className="text-[17px] leading-[1.3] font-black mb-3 md:mb-4">
                Company
              </h3>
            ...
            <div>
              ...
              <div className="space-y-2.5 md:space-y-3 text-white/70 text-[13px] leading-[1.85]">
                <p>Food Products</p>
                <p>Supplements</p>
                <p>Nutraceuticals</p>
              </div>
