  ...
  return (
    <section className="relative bg-[#d3f7f0] overflow-hidden pt-32 md:pt-40 pb-10 md:pb-16">
      ...
      <div className="max-w-[1900px] mx-auto px-4 md:px-6">
        ...
        {/* HERO CONTAINER */}
<div className="relative h-[520px] sm:h-[580px] md:h-[640px] lg:h-[56vw] xl:h-[52vw] 2xl:h-[780px] rounded-[28px] md:rounded-[42px] overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.08)]">
...
className="object-cover object-[72%_bottom]"          />
          ...
          >
            ...
            <div className="w-full bg-white/12 backdrop-blur-2xl border border-white/10 rounded-[22px] sm:rounded-[30px] px-5 py-4 sm:px-7 sm:py-5 shadow-[0_25px_70px_rgba(0,0,0,0.18)]">
              ...
              Shop curated supplements, functional foods, and wellness essentials selected for quality, clarity, and everyday health needs.
              </p>
