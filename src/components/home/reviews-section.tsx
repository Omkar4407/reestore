  ...
  return (
    <section className="py-10 md:py-16 bg-[#d3f7f0] overflow-hidden">
      ...
      <div className="max-w-[1600px] mx-auto px-4 md:px-6">
        ...
        {/* HEADER */}
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-7 md:mb-12 gap-4 md:gap-5">
            ...
            >
              ...
              >
                ...
                <div className="pt-4 mt-auto">
                  ...
                  <p className="mt-1 text-black/50 text-[13px] leading-[1.85]">
                    {review.role}
                  </p>
                </div>
              </div>
