export default function PrivacyPolicyPage() {
  return (
    <main className="pt-28 pb-16 md:pt-40 md:pb-24 px-4 md:px-6">
      <div className="max-w-4xl mx-auto">
        <div className="space-y-20">
          ...
          <section>
            ...
            <p className="mt-4 text-[13px] leading-[1.85] font-medium text-black/70 md:leading-8 md:text-lg">
          ...
          <section>
            ...
            <ul className="space-y-4 text-black/70 text-lg leading-8 list-disc pl-6">
              ...
              <li>Right to portability and transfer requests.</li>
          ...
          <section>
            ...
            <div className="space-y-4 text-black/70 text-lg leading-8">
              <p>Email: ecom@reework.in</p>

              <p>Shamrock PharmaChemi Pvt Ltd</p>

              <p>Upper Worli Worli, 83 E,</p>

              <p>Hansraj Pragji Building,</p>

              <p>Mumbai, MH, 400018, IN</p>
            </div>
          </section>
